...
function reply_post_func($xmlrpc_params)
{
	...
	//Get ipaddr
	$ipaddr = version_compare($mybb->version, '1.8.0','<') ? get_ip() : my_inet_pton(get_ip());
	$post = array(
		"tid" => $input['topic_id'],
		"replyto" => 0,
		"fid" => $thread['fid'],
	...
	$result = new xmlrpcval(array(
        ...
        'post_author_user_type'  => new xmlrpcval(check_return_user_type($mybb->user['username']), 'string'),
