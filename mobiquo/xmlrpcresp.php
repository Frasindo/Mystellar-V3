    ...
    foreach ($search_data['results'] as $item)
    {
        ...
        if($search_data['type'] == 'threads')
        {
            ...
            $return_thread = array(
                ...
                'post_author_user_type'  => new xmlrpcval(check_return_user_type($lastpost ? $lastpost['username'] : $item['lastposter']), 'string'),
                ...
                'last_reply_author_user_type'  => new xmlrpcval(check_return_user_type($lastpost ? $lastpost['username'] : $item['lastposter']), 'string'),
        ...
        else
        {
            $return_post = array(
                ...
                'post_author_user_type'  => new xmlrpcval(check_return_user_type($item['username']), 'string'),
